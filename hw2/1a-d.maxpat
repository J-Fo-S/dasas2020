...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 497.0, 48.0, 168.0, 20.0 ],
					"style" : "",
					"text" : "3. set m samples to average",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 168.0, 358.0, 61.0, 20.0 ],
					"style" : "",
					"text" : "1. turn on",
					"textcolor" : [ 0.462745, 0.470588, 0.490196, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.0, 8.0, 65.0, 33.0 ],
					"style" : "",
					"text" : "2. set frequency",
					"textcolor" : [ 0.462745, 0.470588, 0.490196, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 371.0, 67.0, 38.0, 22.0 ],
					"style" : "",
					"text" : "%~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 371.0, 32.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "+~ 0.75"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 89.0, 267.0, 98.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 89.0, 169.5, 98.0, 20.0 ],
					"style" : "",
					"text" : "read buffer"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 89.0, 204.5, 98.0, 60.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 89.0, 51.0, 98.0, 20.0 ],
					"style" : "",
					"text" : "signal freq"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 89.0, 106.5, 98.0, 20.0 ],
					"style" : "",
					"text" : "signal inputs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 295.0, -3.0, 98.0, 20.0 ],
					"style" : "",
					"text" : "ramp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 238.0, 169.5, 80.0, 22.0 ],
					"style" : "",
					"text" : "poke~ in_buf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 295.0, 60.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 295.0, 19.0, 64.0, 22.0 ],
					"style" : "",
					"text" : "phasor~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 232.0, 50.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 238.0, 267.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "tanh~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 345.0, 106.5, 45.0, 22.0 ],
					"style" : "",
					"text" : "cycle~"
				}
...
,
					"patching_rect" : [ 238.0, 202.5, 38.0, 22.0 ],
					"style" : "",
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 238.0, 106.5, 54.0, 22.0 ],
					"style" : "",
					"text" : "phasor~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 238.0, 352.0, 45.0, 45.0 ],
					"style" : ""
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 460.0, 336.0, 865.0, 336.0 ],
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-21", 0 ],
					"midpoints" : [ 247.5, 189.0, 237.0, 189.0, 237.0, 252.0, 312.0, 252.0, 312.0, 267.0, 865.0, 267.0 ],
					"order" : 0,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 247.5, 156.0, 247.5, 156.0 ],
					"order" : 3,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 247.5, 129.0, 247.5, 129.0 ],
					"order" : 2,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 247.5, 138.0, 330.0, 138.0, 330.0, 93.0, 357.0, 93.0, 357.0, 42.0, 366.0, 42.0, 366.0, 27.0, 380.5, 27.0 ],
					"order" : 1,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 241.5, 93.0, 324.0, 93.0, 324.0, 54.0, 315.0, 54.0 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 377.5, 162.0, 278.0, 162.0 ],
					"order" : 1,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 377.5, 219.0, 370.5, 219.0 ],
					"order" : 0,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 304.5, 42.0, 304.5, 42.0 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 304.5, 93.0, 247.5, 93.0 ],
					"order" : 1,
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 304.5, 93.0, 354.5, 93.0 ],
					"order" : 0,
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 515.5, 102.0, 696.0, 102.0, 696.0, 75.0, 885.5, 75.0 ],
					"order" : 0,
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 247.5, 252.0, 312.0, 252.0, 312.0, 267.0, 401.0, 267.0 ],
					"order" : 0,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"midpoints" : [ 247.5, 234.0, 312.0, 234.0, 312.0, 228.0, 336.5, 228.0 ],
					"order" : 1,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 247.5, 225.0, 247.5, 225.0 ],
					"order" : 2,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-21", 0 ],
					"midpoints" : [ 354.5, 165.0, 378.0, 165.0, 378.0, 219.0, 543.0, 219.0, 543.0, 267.0, 865.0, 267.0 ],
					"order" : 0,
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"midpoints" : [ 354.5, 156.0, 247.5, 156.0 ],
					"order" : 2,
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 1 ],
					"midpoints" : [ 247.5, 339.0, 273.5, 339.0 ],
					"order" : 0,
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 247.5, 291.0, 247.5, 291.0 ],
					"order" : 1,
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 448.5, 102.0, 402.0, 102.0, 402.0, 93.0, 315.0, 93.0, 315.0, 156.0, 247.5, 156.0 ],
					"source" : [ "obj-7", 0 ]
				}
